...
from codes.models.components.gin_graph_stack import GINStack
from codes.models.predictors.predictor_gin import Predictor
...
class Model(nn.Module):
    ...
    def load(cls, config: ModelConfig):
        ...
        # Derive predictor input channels from the head if available, else fall back
