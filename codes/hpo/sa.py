...
def main():
    ...
    ap.add_argument("--start_temp", type=float, default=1.0)
    ...
    algo = SimulatedAnnealing(delta=args.delta, starting_temperature=args.start_temp,
                              delta_temperature=args.cool, seed=args.seed)
